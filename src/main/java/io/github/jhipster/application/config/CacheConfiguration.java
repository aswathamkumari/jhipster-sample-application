...
public class CacheConfiguration {
    ...
    public JCacheManagerCustomizer cacheManagerCustomizer() {
        return cm -> {
            ...
            cm.createCache(io.github.jhipster.application.domain.ProvisioningStatus.class.getName(), jcacheConfiguration);
            cm.createCache(io.github.jhipster.application.domain.ProvisioningStatus1.class.getName(), jcacheConfiguration);
